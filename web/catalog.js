...
window.SINKI_CATALOG = {
  plus: {
    week: { id: "sinki.plus.week", family: "plus", period: "week", eur: 2.99, apple: "sinki.plus.week", google: "sinki.plus.week" },
    month: { id: "sinki.plus.month", family: "plus", period: "month", eur: 9.99, apple: "sinki.plus.month", google: "sinki.plus.month" },
    year: { id: "sinki.plus.year", family: "plus", period: "year", eur: 99.99, apple: "sinki.plus.year", google: "sinki.plus.year" },
  },
  unlimited: {
    week: { id: "sinki.unlimited.week", family: "unlimited", period: "week", eur: 1.99, apple: "sinki.unlimited.week", google: "sinki.unlimited.week" },
    month: { id: "sinki.unlimited.month", family: "unlimited", period: "month", eur: 7.99, apple: "sinki.unlimited.month", google: "sinki.unlimited.month" },
    year: { id: "sinki.unlimited.year", family: "unlimited", period: "year", eur: 89.99, apple: "sinki.unlimited.year", google: "sinki.unlimited.year" },
  },
  event: {
